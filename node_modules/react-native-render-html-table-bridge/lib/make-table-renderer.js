...
function makeTableRenderer(tableConfig) {
    return (attribs, _children, _css, { key, onLinkPress, renderersProps }) => {
        ...
        return react_1.default.createElement(HTMLTable_1.default, Object.assign({ key: key }, tableConfig, { numOfColumns: attribs._numOfColumns, numOfRows: attribs._numOfRows, numOfChars: attribs._numOfChars, html: attribs._rawHtml, renderersProps: renderersProps, onLinkPress: handleOnLinkPress }));
    };
}
...
function makeCustomTableRenderer(TableComponent) {
    return (attribs, _children, _css, { key, onLinkPress, renderersProps }) => {
        ...
        return react_1.default.createElement(TableComponent, { key: key, numOfColumns: attribs._numOfColumns, numOfRows: attribs._numOfRows, numOfChars: attribs._numOfChars, html: attribs._rawHtml, renderersProps: renderersProps, onLinkPress: handleOnLinkPress });
    };
}
